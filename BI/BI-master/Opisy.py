...
account_how_long_text = "ile lat będziez trzymał środki\n"
...
"""create deposit"""
depo_menu_text = "Zapraszamy do skoszystania z baszej bogatej oferty.\nDzięki dostoswanej do każdego oferty, " \
                 "napewno znajdziesz coś dla siebie.\n"

depo_range_text = "Na jaki okres chcesz otowrzyć lokatę? \nJedno Miesięczna (m) \nTrzy miesięczna (t) "
"\nSześciomiesięczną (s) \nRoczną (r) \nPowrót do menu (e)\n"
